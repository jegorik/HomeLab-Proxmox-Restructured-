# =============================================================================
# LXC Grafana Loki - Terraform Outputs
# =============================================================================
...
output "lxc_id" {
  ...
  value       = proxmox_virtual_environment_container.loki.vm_id
}
...
output "deployment_summary" {
  ...
  value       = <<-EOT
    ...
    Container:  ${var.lxc_hostname} (VMID: ${proxmox_virtual_environment_container.loki.vm_id})
