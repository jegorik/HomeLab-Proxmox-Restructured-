# =============================================================================
# LXC Grafana Loki - NetBox Registration
# =============================================================================
...
resource "netbox_virtual_machine" "lxc" {
  ...
  comments = <<-EOT
    LXC Container deployed by lxc_grafana_loki
...
resource "netbox_ip_address" "primary" {
  ...
  # Assuming for now lxc_grafana_loki encourages static IPs for infrastructure.
