# =============================================================================
# LXC InfluxDB - Main Terraform Configuration
# =============================================================================
...
resource "proxmox_virtual_environment_container" "influxdb" {
  ...
  # Bind Mount Configuration for InfluxDB
  # ---------------------------------------------
  # InfluxDB stores all data in /var/lib/influxdb (including influxd.bolt and engine/)

  mount_point {
    volume = var.lxc_influxdb_data_mount_volume
    path   = var.lxc_influxdb_data_mount_path
  }
...
resource "terraform_data" "ansible_user_setup" {
  ...
  triggers_replace = [
    proxmox_virtual_environment_container.influxdb.id,
  ]
