# =============================================================================
# VM Docker Pool - Provider Configuration
# =============================================================================
#
...
provider "vault" {
  ...
  # Token is set by sourcing vault.sh which authenticates via userpass
...
provider "proxmox" {
  ...
  # Authentication via username/password (required for bind mount setup)
