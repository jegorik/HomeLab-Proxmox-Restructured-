#!/usr/bin/env bash
# =============================================================================
# Terraform/OpenTofu Functions for VM Docker Pool
# =============================================================================
...
terraform_destroy() {
    ...
    log_warning "This will DESTROY the Docker Pool VM and all its data!"
    log_warning "Note: Portainer data in /rpool/datastore/portainer will be preserved."
